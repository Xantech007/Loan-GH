<?php
// register.php - CedisPay Member Registration (Email + Phone version)
session_start();
        ...
        if (empty($full_name) || empty($email) || empty($phone) || empty($password) || empty($confirm)) {
            ...
            if ($result->num_rows > 0) {
                ...
                if ($stmt->execute()) {
                    ...
                    // Hash password and create login account
                    ...
                    $success = "Account created successfully!<br>
                                <strong>Your Member ID / Username: $username</strong><br>
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .col-2 img { max-width: 70%; opacity: 0.9; }
        .container {
        ...
        .back-to-login { text-align: center; margin-top: 25px; font-size: 14px; }
        .back-to-login a { color: var(--primary-color); text-decoration: none; font-weight: 600; }
    ...
    <div class="main-container">
        <div class="container">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    <input type="text" name="phone" required pattern="[0-9]{10}" title="10-digit phone number (e.g. 0241234567)">
